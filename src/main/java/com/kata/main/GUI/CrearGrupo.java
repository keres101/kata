...
public class CrearGrupo extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(inputName, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(80, 80, 80))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // TODO add your handling code here:
        String miembros = txtEmails.getText();
        String name = inputName.getText();
        String[] miembrosArray = miembros.split("\n");
        if (miembrosArray.length > 0) {
            boolean res = Server.crearChat(usuario.getToken(), name, miembrosArray);
            if (res) {
                System.out.println("Se creo el chat");
            }
        } else {
            System.out.println("no se puede crear el grupo, pocos miembros");
        }
